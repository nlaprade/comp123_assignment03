using System;
using Assignment03_COMP123.Models;

namespace Assignment03_COMP123
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Time time1 = new Time(14, 10);
            Time time2 = new Time(17, 05);
            Time time3 = new Time(14, 05);

            Console.WriteLine("This is the time == time:");
            Console.WriteLine(time2 == time);
            Console.WriteLine(time1 == time);
            Console.WriteLine(time3 == time);
            Console.WriteLine("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            Console.WriteLine("This is the time.equals(time):");
            Console.WriteLine(time2.Equals(time));
            Console.WriteLine(time1.Equals(time));
            Console.WriteLine(time3.Equals(time));
            // Checking if the Time Struct logic is working correctly.
            // Checking to see if I correctly overrided equals.
